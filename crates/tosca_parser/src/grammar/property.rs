use super::{Boolean, Map, SchemaDefinition, Value};
...
pub type PropertyDefinitions = Map<String, PropertyDefinition>;

pub type PropertyAssignment = Value;

pub type PropertyAssignments = Map<String, PropertyAssignment>;
